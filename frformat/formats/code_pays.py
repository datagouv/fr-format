...
CodePaysISO2 = new("CodePaysISO2", name, description, source, code_pays_IS02_versioned_data)
...
CodePaysISO3 = new("CodePaysISO3", name, description, source, code_pays_IS03_versioned_data)
