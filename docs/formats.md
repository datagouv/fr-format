...
| CodePostal | Code postal | Code postal français. La dernière mise à jour date du 8 février 2025 |
| CodeRegion | Code région | Code région pour un Code Officiel Géographique donné. À partir du Millesime 2016 la liste des régions françaises change suite à plusieurs fusions |
| Commune | Nom de commune | Nom de commune française pour un Code Officiel Géographique donné (ne vérifie pas l'accentuation, la casse, la ponctuation) |
| CoordonneesGPSFrancaises | Coordonnées GPS françaises | Coordonnées GPS compris dans les polygones (approximés) du territoire français, DOM compris |
...
| Siret | SIRET | Numéro SIRET (vérifie la validité intrinsèque, mais pas l'attribution du SIRET) |
