...
from frformat.geo.canton_frozenset import (
    CANTON_FROZEN_SET_COG_2023,
    CANTON_FROZEN_SET_COG_2024,
)
...
all_cog_versions: Dict[Millesime, FrozenSet[str]] = {
    Millesime.A2023: CANTON_FROZEN_SET_COG_2023,
    Millesime.A2024: CANTON_FROZEN_SET_COG_2024,
}
