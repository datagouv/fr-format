...
CodePaysISO2 = enum_format.new("CodePaysISO2", name, description, CODE_PAYS_ISO2_SET)

name = "Codes ISO3 Pays"
description = "Code ISO 3 de pays selon COG2024"

CodePaysISO3 = enum_format.new("CodePaysISO3", name, description, CODE_PAYS_ISO3_SET)
