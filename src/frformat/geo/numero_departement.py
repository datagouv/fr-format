...
DEPARTEMENTS_FROZEN_SET_COG_2023 = frozenset(
    (
...
DEPARTEMENTS_FROZEN_SET_COG_2024 = DEPARTEMENTS_FROZEN_SET_COG_2023
...
all_cog_versions: Dict[Millesime, FrozenSet[str]] = {
    Millesime.A2023: DEPARTEMENTS_FROZEN_SET_COG_2023,
    Millesime.A2024: DEPARTEMENTS_FROZEN_SET_COG_2024,
}
